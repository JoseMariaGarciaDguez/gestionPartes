        ...
        <section class="col-lg-12">
			<div class="box box-primary">
			  <div class="box-header with-border">
				<h3 class="box-title">Modificar obra</h3>
			  </div>

			  <div class="box-body">

				<form data-toggle="validator" accept-charset="UTF-8" role="form" id="formEditarObra">
                    <fieldset>	
						<div class="form-group  has-feedback">
							<label for="nombre">Nombre *</label>
							<input class="form-control" placeholder="Nombre" maxlength="32" value="<?php echo $obra->nombre; ?>"  name="nombre" type="text" 
						...
						<div class="form-group  has-feedback">
							...
							<select name="clienteID" class="form-control selectpicker" data-live-search="true"  title="Selecciona un cliente...">
								...
								<?php	foreach ($query as $row){ ?>
									<option <?php if($obra->clienteID == $row['id']) echo "selected"; ?> value="<?=$row['id'];?>"><?=$row['nombre'];?></option>
								<?php } ?>
							</select>
						...
						<div class="form-group  has-feedback">
							...
							<textarea class="form-control" rows="5" placeholder="Descripcion" maxlength="250" name="descripcion"><?php echo $obra->descripcion; ?></textarea>
							<div class="help-block with-errors"></div>
						</div>
			    		<div class="form-group">
							<section class="col-lg-4">
								<img src="<?php echo base_url(); ?>/assets/images/obras/<?php echo $obra->avatar; ?>" data-name="<?php echo $obra->avatar; ?>" id="imgAvatar"/>
							</section>
			  ...
			  <div class="box-footer">
					<button class="btn btn-lg btn-success btn-block" id="btn_editarObra" data-obra="<?php echo $obra->id; ?>">Editar obra</button>				
			  </div>
			</div>
